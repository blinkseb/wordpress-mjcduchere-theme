...
// Project paths
var project     = 'mjc-duchere',                // The directory name for your theme; change this at the very least!
...
module.exports = {
  ...
  browsersync: {
    ...
    proxy: 'mjcduchere.dev', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
  ...
  theme: {
    ...
    fonts: {
      src: src+'font/*', // Glob pattern matching any language files you'd like to copy over; we've broken this out in case you want to automate language-related functions
      dest: build+'font/'
    },
    php: {
