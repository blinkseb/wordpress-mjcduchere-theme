...
$views   = array(
		...
		"anchor" =>  "Liste",
		"url" =>  "http://mjcduchere.fr/evenements/a-venir"
		),
		array(
		"displaying" =>  "month",
		"event_bar_hook" =>  "tribe_events_before_template",
		"anchor" =>  "Calendrier",
		"url" =>  "http://mjcduchere.fr/evenements/mois"
		)
	);
		...
		<div class="tribe-bar-filters">
			<div class="tribe-bar-filters-inner tribe-clearfix">
				...
				<div class="tribe-bar-submit">
					<input class="tribe-events-button tribe-no-param" type="submit" name="submit-bar" value="<?php _e( 'Recherche', 'tribe-events-calendar' ) ?>" />
